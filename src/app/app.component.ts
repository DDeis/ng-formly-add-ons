...
export class AppComponent implements AfterViewChecked {
  ...
  ngOnInit() {
    ...
    const fields = [
      this.titleField,
      this.buildFieldGroup('iptc', [this.iptcField, this.keywordsField]),
  ...
  /**
	 ...
	 * @param method
	 */
  private onChangeIPTC(iptcID: string, method: (target: any, origin: any, lang: string) => void): void {
  ...
  private buildFieldGroup(id: string, fields: FormlyFieldConfig[], options?: { fieldClassNames?: string[] }): FormlyFieldConfig {
    ...
    fields.forEach((field, index) => {
      field.className = options && options.fieldClassNames ? options.fieldClassNames[index] : 'col';
    });
